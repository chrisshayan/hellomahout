 ...
 */
public class SimpleUserBasedJobRecommender {
    /**
     * @param userId the user to generate recommendation
     * @return recommendation for userId based on sample data in data/jobMockDataSimplified.csv
     */
    public List<RecommendedItem> getRecommendation(@NotNull long userId) throws TasteException, IOException {
        final File sampleDataUserItemScore = new File(
                System.getProperty("user.dir") + File.separator + "src/main/resources/data/jobMockDataSimplified.csv");
